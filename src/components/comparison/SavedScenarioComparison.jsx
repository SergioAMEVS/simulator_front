...
import SmallTableComparison from './SmallTableComparison'
...
const SavedScenarioComparison = ({
  savedScenario,
  refetch,
  isNotComparison = true,
  currentScenario
}) => {
...
export default SavedScenarioComparison

SavedScenarioComparison.propTypes = {
